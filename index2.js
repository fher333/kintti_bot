...
bot0.onText(/\/echo (.+)/, function(msg,match){   //la funcion onText permite recibir los textos e ID de quien ingresa al Bot
    ...
    bot0.sendMessage(chatId, "Hola, " + username + " soy un bot y mi nombre es Gerh");
    bot0.sendMessage(chatId,echo);    
    bot1.sendMessage('933443152',echo); //933443152 es el numero identificador de la chica   
});
