...
]; // in this array push the each user into the principal bot chat 
...
console.log(typeAnswer);
    ...
    switch (roomSelect) {
            ...
            if (typeAnswer=="textNoAcceptUser") {
                ...
                botRoom1.sendMessage(girlChat,textNoAccept);
                ...
                botRoom1.sendMessage(girlChat,nameGirl+" dice: "+msgText);  
            }
            ...
            case 5:
                ...
                if (typeAnswer=='textNoAcceptUser') {            
                    ...
                    botMonitor.sendMessage(monitor.ID,nameGirl+' intenta enviar texto no aceptado: "'+msgText+'"');        
                } else if (typeAnswer=='toUser') {
                    botRoom5.sendMessage(userChat,nameGirl+' dice: '+msgText);
                    botMonitor.sendMessage(monitor.ID, nameGirl+' dice a '+nameUser+': '+msgText);
                } else if (typeAnswer=='toGirl') {
                    botRoom5.sendMessage(girlChat,nameUser+' dice: '+msgText);  
                    botMonitor.sendMessage(monitor.ID, nameUser+' dice a '+nameGirl+': '+msgText);
                }
            break;
...
function sendMessageUserGirl(msgText,whoWriteId,userChat,girlChat,nameUser,nameGirl) {
    ...
    if (whoWriteId==userChat)
    {
            ...
            if (Upos==1)
            {
                sendMessageRoom(msgText,5,userChat,girlChat,"textNoAcceptUser",nameUser,nameGirl);
                ...
                sendMessageRoom(msgText,5,userChat,girlChat,"toGirl",nameUser,nameGirl);
            ...
            if (Gpos==1){
                ...
                sendMessageRoom(msgText,5,userChat,girlChat,'textNoAcceptGirl',nameUser,nameGirl);
                ...
                sendMessageRoom(msgText,5,userChat,girlChat,"toUser",nameUser,nameGirl);
...
botRoom2.on('message', function(msg){   //la funcion onText permite recibir los textos e ID de quien ingresa al Bot
    ...
    var echo = msg.text;
    sendMenssageUserGirl(echo,chatId,userChat12,girlChat12,username,girlName12);
...
botRoom5.on('message', function(msg){   //la funcion onText permite recibir los textos e ID de quien ingresa al Bot
    ...
    sendMessageUserGirl(echo,chatId,userChat15,girlChat15,username,girlName15);
